...
//                     </Link>
//                 </div>
//                 <div className="flex flex-wrap mt-1 hidden lg:block">
//                     <Link href="/">
//                         <a className="mb-4 text-left mr-4">Home</a>
//                     </Link>
//                     <Link href="/New">
//                         <a className="mb-4 text-left mr-4">Cables</a>
//                     </Link>
//                     <Link href="/Products">
//                         <a className="mb-4 text-left mr-4">Products</a>
//                     </Link>
//                     <Link href="/#Contact">
//                         <a className="mb-4 text-left mr-4">Contact Us</a>
//                     </Link>
//                     <Link href="/About">
//                         <a className="mb-4 text-left mr-4">About Us</a>
//                     </Link>
//                 </div>
//             </div>
//
