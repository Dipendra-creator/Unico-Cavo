...
export default function About () {
        ...
        <>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <h1 className="text-3xl font-medium title-font text-gray-900 mb-12 text-center">VISION & MISSION</h1>
    ...
    d="M925.036 57.197h-304c-27.6 0-50 22.4-50 50v304c0 27.601 22.4 50 50 50h145.5c-1.9 79.601-20.4 143.3-55.4 191.2-27.6 37.8-69.399 69.1-125.3 93.8-25.7 11.3-36.8 41.7-24.8 67.101l36 76c11.6 24.399 40.3 35.1 65.1 24.399 66.2-28.6 122.101-64.8 167.7-108.8 55.601-53.7 93.7-114.3 114.3-181.9 20.601-67.6 30.9-159.8 30.9-276.8v-239c0-27.599-22.401-50-50-50zM106.036 913.497c65.4-28.5 121-64.699 166.9-108.6 56.1-53.7 94.4-114.1 115-181.2 20.6-67.1 30.899-159.6 30.899-277.5v-239c0-27.6-22.399-50-50-50h-304c-27.6 0-50 22.4-50 50v304c0 27.601 22.4 50 50 50h145.5c-1.9 79.601-20.4 143.3-55.4 191.2-27.6 37.8-69.4 69.1-125.3 93.8-25.7 11.3-36.8 41.7-24.8 67.101l35.9 75.8c11.601 24.399 40.501 35.2 65.301 24.399z"/>
                                ...
                                <p className="leading-relaxed mb-6">To be an internationally reputed brand that delivers world class products and services in terms of their quality and the technology used, to ensure 100% consumer satisfaction without losing focus on its employee welfare.</p>
                            </div>
                        </div>
                        <div className="p-4 md:w-1/2 w-full">
                            <div className="h-full bg-gray-100 p-8 rounded">
    ...
    d="M925.036 57.197h-304c-27.6 0-50 22.4-50 50v304c0 27.601 22.4 50 50 50h145.5c-1.9 79.601-20.4 143.3-55.4 191.2-27.6 37.8-69.399 69.1-125.3 93.8-25.7 11.3-36.8 41.7-24.8 67.101l36 76c11.6 24.399 40.3 35.1 65.1 24.399 66.2-28.6 122.101-64.8 167.7-108.8 55.601-53.7 93.7-114.3 114.3-181.9 20.601-67.6 30.9-159.8 30.9-276.8v-239c0-27.599-22.401-50-50-50zM106.036 913.497c65.4-28.5 121-64.699 166.9-108.6 56.1-53.7 94.4-114.1 115-181.2 20.6-67.1 30.899-159.6 30.899-277.5v-239c0-27.6-22.399-50-50-50h-304c-27.6 0-50 22.4-50 50v304c0 27.601 22.4 50 50 50h145.5c-1.9 79.601-20.4 143.3-55.4 191.2-27.6 37.8-69.4 69.1-125.3 93.8-25.7 11.3-36.8 41.7-24.8 67.101l35.9 75.8c11.601 24.399 40.501 35.2 65.301 24.399z"/>
                                ...
                                <p className="leading-relaxed mb-6">To touching Lives and Empowering People with world class products and services in terms of their quality and the technology.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="p-8">
                ...
                <p className="text-center mt-6 text-lg font-light text-gray-500"> Strict adherence to quality to make superior & incomparable products in the market forms the guiding principle towards every manufactured product. </p></div>
            <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="p-8">
                    ...
                    className="font-light text-sm text-gray-500 mb-3"> The lamp and lighting laboratory takes a medium to long range point of view to basic and applied research for new technology and new products. </p>
                    <a
                ...
                <div className="p-8">
                    ...
                    <h2 className="uppercase mt-6 text-green-500 font-medium mb-3"> Quality Assurance Division </h2>    <p
                    className="font-light text-sm text-gray-500 mb-3"> The lamp and lighting laboratory takes a medium to long range point of view to basic and applied research for new technology and new products. </p>    <a
                ...
                <div className="p-8">
                    ...
                    className="font-light text-sm text-gray-500 mb-3"> Based upon information provided by R & D department the Design Centre develops designs to meet quality lifestyle objectives. </p>
                    <a
